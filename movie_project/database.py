...
def create_tables():
    with connection:
        connection.execute(CREATE_MOVIES_TABLES)
        connection.execute(CREATE_USERS_TABLES)
...
def add_user(username):
    with connection:
        connection.execute(INSRET_USER, (username,))
...
INSRET_USER = "INSERT INTO users (username) VALUES (?);"
